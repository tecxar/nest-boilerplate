...
export default class BorrowersHistory extends BaseModel<IBorrowersHistory> implements IBorrowersHistory {
    ...
    @Column({ type: ENUM(GenderTypeEnum.female, GenderTypeEnum.male), allowNull: true })
